<?php
	...
	$sql="UPDATE new_item SET  product='$product', model='$model', description='$description', price='$price', quantity='$quantity', amount='$amount', gst='$gst', t_amount ='$t_amount' where item_id='$id'";
