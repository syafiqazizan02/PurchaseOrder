      ...
      <div class="container-fluid">
                ...
                <div class="row">
					<div align="left" class="col-lg-8">
						&nbsp;&nbsp;&nbsp;<?php echo "<a href='pro_display_order.php?username=$username'><input type='button' class='btn btn-success btn-lg'  value='NEW ORDER'></a>"; ?>
					</div>
                    ...
                    <div class="col-lg-12">
						...
						<div class="table-responsive">
							...
							<?php
								...
								{
									$sql = "SELECT * FROM pro_request WHERE username='$a' AND status=1 ORDER BY prodate DESC";
								}						
								...
								while($row=mysql_fetch_array($result))
								{
									...
									if($x>$min && $x<$max)
									{
										...
										echo "<td align='center'>
												<a href='pro_view_item.php?username=$username&&res_id=".$row['res_id']."'><button type='submit'  name='view' class='btn btn-info btn-xs'><span class='glyphicon glyphicon-list'></span></button></a>
												<a href='pro_delete_order.php?username=$username&&id=".$row['res_id']."'><button type='submit' name='delete' class='btn btn-danger btn-xs'><span class='glyphicon glyphicon-trash'></span></button></a>
											  </td>";
									}
								}
								echo "</table>";
							...
							<center>
								<?php
									...
									{
								?>
										<a href="pro_status_order.php?username=<?php echo "$username"?>&&page=<?php echo $page-1; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;">&nbsp;&nbsp;&nbsp;Prev&nbsp;&nbsp;&nbsp;</button></a>
								<?php
									}
								?>
								<?php
									...
									{
								?>
									<a href="pro_status_order.php?username=<?php echo "$username"?>&&page=<?php echo $page-2; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;"><?php echo $page-2; ?></button></a>
								<?php
									}
									...
									{
								?>
									<a href="pro_status_order.php?username=<?php echo "$username"?>&&page=<?php echo $page-1; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;"><?php echo $page-1; ?></button></a>
								<?php
									}
									if($max_page!=1){
								?>
									<a href="pro_status_order.php?username=<?php echo "$username"?>&&page=<?php echo $page; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;"><?php echo $page; ?></button></a>
								<?php
									}
								...
								<?php
									...
									{
								?>
										<a href="pro_status_order.php?username=<?php echo "$username"?>&&page=<?php echo $page+1; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;">&nbsp;&nbsp;&nbsp;Next&nbsp;&nbsp;&nbsp;</button></a>
								<?php
									}
								}
								?>
