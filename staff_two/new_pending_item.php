...
<body>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li>
                        <a href="new_pending_item.php"><i class="fa fa-fw fa-table"></i>&nbsp;&nbsp;Pending Item</i></a>
                    </li>
					<li>
                        <a href="new_delivered_item.php"><i class="fa fa-fw fa-align-justify"></i>&nbsp;&nbsp;Delivered Item</i></a>
                    </li>
                    <li>
    ...
    <div id="page-wrapper">
      ...
      <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h2 align="center" class="page-header">Pending Item</h2>	
						<ol class="breadcrumb">
                            <li class="active">
                    ...
                    <div class="col-lg-12">
						...
						<div class="table-responsive">
							...
							<?php
								...
								{
									$sql = "SELECT * FROM new_request WHERE status=1 AND delivered=1 AND approve=0 ORDER BY prodate DESC, res_id DESC";
								}	
									...
									if($x>$min && $x<$max)
									{
										...
										if($i%2==0)
												...
												echo "<td align='center'>
														<a href='new_view.php?res_id=".$row['res_id']."'>
															<button type='submit'  name='view' class='btn btn-info btn-xs'><span class='glyphicon glyphicon-list'></span></button></a></td>";
													  
												$approve=$row['approve'];
							
												echo "<td align=center>
														<form action='new_approve_button.php' method='post' >
															<input type='hidden' name='res_id' value='".$row['res_id']."'>";
															
															if($approve==1)
															{
																echo "<button type='submit' name='done' class='btn-success btn-sm'>Complate</button>";
															}
															else
															{
							...
							<center>
								<?php
									...
									{
								?>
										<a href="new_pending_item.php?page=<?php echo $page-1; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;">&nbsp;&nbsp;&nbsp;Prev&nbsp;&nbsp;&nbsp;</button></a>
								<?php
									}
								?>
								<?php
									...
									{
								?>
									<a href="new_pending_item.php?page=<?php echo $page-2; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;"><?php echo $page-2; ?></button></a>
								<?php
									}
									...
									{
								?>
									<a href="new_pending_item.php?page=<?php echo $page-1; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;"><?php echo $page-1; ?></button></a>
								<?php
									}
									if($max_page!=1){
								?>
									<a href="new_pending_item.php?page=<?php echo $page; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;"><?php echo $page; ?></button></a>
								<?php
									}
								...
								<?php
									...
									{
								?>
										<a href="new_pending_item.php?page=<?php echo $page+1; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;">&nbsp;&nbsp;&nbsp;Next&nbsp;&nbsp;&nbsp;</button></a>
								<?php
									}
								}
								?>
