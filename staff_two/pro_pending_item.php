                    ...
                    <div class="col-lg-12">
						...
						<div class="table-responsive">
							...
							<?php
								...
								{
									$sql = "SELECT * FROM pro_request WHERE status=1 AND delivered=1 AND approve=0 ORDER BY prodate DESC, res_id DESC";
								}	
								...
								while($row=mysql_fetch_array($result))
								{
									...
									if($x>$min && $x<$max)
									{
										...
										if($i%2==0)
												...
												echo "<td align=center>
														<form action='pro_approve_button.php' method='post' >
							...
							<center>
								<?php
									...
									{
								?>
										<a href="pro_pending_item.php?page=<?php echo $page-1; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;">&nbsp;&nbsp;&nbsp;Prev&nbsp;&nbsp;&nbsp;</button></a>
								<?php
									}
								?>
								<?php
									...
									{
								?>
									<a href="pro_pending_item.php?page=<?php echo $page-2; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;"><?php echo $page-2; ?></button></a>
								<?php
									}
									...
									{
								?>
									<a href="pro_pending_item.php?page=<?php echo $page-1; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;"><?php echo $page-1; ?></button></a>
								<?php
									}
									if($max_page!=1){
								?>
									<a href="pro_pending_item.php?page=<?php echo $page; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;"><?php echo $page; ?></button></a>
								<?php
									}
								...
								<?php
									...
									{
								?>
										<a href="pro_pending_item.php?page=<?php echo $page+1; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;">&nbsp;&nbsp;&nbsp;Next&nbsp;&nbsp;&nbsp;</button></a>
								<?php
									}
								}
								?>
