...
<body>
    ...
    <div id="page-wrapper">
      ...
      <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h2 align="center" class="page-header">ACCOUNT PERSON</h2>
                    </div>
                </div><br><br>
                    ...
                    <div class="col-lg-12">
						...
						<div class="table-responsive">
							...
							<?php
								...
								{
									$sql = "SELECT * FROM staff_two ORDER BY id DESC";
								}	
									...
									if($x>$min && $x<$max)
									{
										...
										if($i%2==0)
												...
												echo "<td align='center'>
														<a href='edit_account.php?id=".$row['id']."'>
							...
							<center>
								<?php
									...
									{
								?>
										<a href="account.php?page=<?php echo $page-1; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;">&nbsp;&nbsp;&nbsp;Prev&nbsp;&nbsp;&nbsp;</button></a>
								<?php
									}
								?>
								<?php
									...
									{
								?>
									<a href="account.php?page=<?php echo $page-2; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;"><?php echo $page-2; ?></button></a>
								<?php
									}
									...
									{
								?>
									<a href="account.php?page=<?php echo $page-1; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;"><?php echo $page-1; ?></button></a>
								<?php
									}
									if($max_page!=1){
								?>
									<a href="account.php?page=<?php echo $page; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;"><?php echo $page; ?></button></a>
								<?php
									}
								...
								<?php
									...
									{
								?>
										<a href="account.php?page=<?php echo $page+1; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;">&nbsp;&nbsp;&nbsp;Next&nbsp;&nbsp;&nbsp;</button></a>
								<?php
									}
								}
								?>
