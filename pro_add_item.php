<?php
	...
	$sql="INSERT INTO pro_item (username, res_id, client_name, company_name, redate, product, model, description, price, quantity, amount, gst, t_amount) VALUES ('".$username."','".$res_id."','".$client_name."','".$company_name."','".$redate."','".$product."','".$model."','".$description."','".$price."','".$quantity."','".$amount."','".$gst."','".$t_amount."')";
