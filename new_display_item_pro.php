...
<form action="new_add_bundle.php" method="post">
                  ...
                  <div class="col-lg-12">
						...
						<div class="col-lg-6">
							...
							<div  align="center" class="form-group">
								...
								<?php echo "<a href='new_view_item.php?username=$username&&res_id=$res_id'><input type='button' class='btn btn-warning' value='BACK'></a>";?>
