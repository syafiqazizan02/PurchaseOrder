				...
				<div class="row">
					...
					<div>
						<table>
							...
							<tr height="60">
							<td></td>
							<td ><label><?php echo "<a href='pro_display_item.php?res_id=$res_id'><input type='button' class='btn btn-success' value=' ADD ORDER '></a>";?></label></td>
							</tr>
						</table>
					</div>
				</div><br>
				...
				<div class="row">
					...
					<div class="col-lg-12">
						...
						<?php
							...
							$result = mysql_query("SELECT * from pro_item WHERE res_id='$a' ");
							...
							echo "<tr bgcolor='#c2c2a3' height='70'>
									<td align='right'colspan='11'><b>Total&nbsp; Price&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td>
