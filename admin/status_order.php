...
<body>
    ...
    <div id="page-wrapper">
      ...
      <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h2 align="center" class="page-header">SUCCESS ORDER</h2>	
						<ol class="breadcrumb">
                            <li class="active">
                    ...
                    <div class="col-lg-12">
						...
						<div class="table-responsive">
							...
							<?php
								...
								{
									$sql = "SELECT * FROM request WHERE status=1 ORDER BY prodate DESC, res_id DESC";
								}	
								...
								while($row=mysql_fetch_array($result))
								{
									...
									if($x>$min && $x<$max)
									{
										...
										if($i%2==0)
												...
												echo "<td align='center'>".$row['attn']."</td>";
												...
												echo "<td align='center'>
														<a href='edit_order.php?res_id=".$row['res_id']."'>
															<button type='submit'  name='edit' class='btn btn-success btn-xs'><span class='glyphicon glyphicon-edit'></span></button></a>
														<a href='view_item.php?res_id=".$row['res_id']."'>
															<button type='submit'  name='view' class='btn btn-info btn-xs'><span class='glyphicon glyphicon-list'></span></button></a>
														<a href='delete_order.php?id=".$row['res_id']."'>
															<button type='submit' name='delete' class='btn btn-danger btn-xs'><span class='glyphicon glyphicon-trash'></span></button></a></td>";
												echo "<td align=center>
														<form action='purchase_order.php' method='post' enctype='multipart/form-data' target='print_popup'  onsubmit='window.open('about:blank','print_popup','width=800,height=900');'>
															<input type='hidden' name='res_id' value='".$row['res_id']."'>
															<button type='submit' name='submit' class='btn-default btn-xs'><span class='glyphicon glyphicon-print'></span></button>";
												echo" 	</form>
													  </td>";
												...
												echo "<td align=center>
														<form action='status_button.php' method='post' >
															<input type='hidden' name='res_id' value='".$row['res_id']."'>";
															
															if($status==1)
															{
																echo "<button type='submit' name='done' class='btn-success btn-sm'>DONE</button>";
															}
															else
															{
																echo "<button type='submit' name='process' class='btn-danger btn-sm'>PROCESS</button>";
															}
												echo " </form>
												     </td>";											
												}
							...
							<center>
								<?php
									...
									{
								?>
										<a href="status_order.php?page=<?php echo $page-1; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;">&nbsp;&nbsp;&nbsp;Prev&nbsp;&nbsp;&nbsp;</button></a>
								<?php
									}
								?>
								<?php
									...
									{
								?>
									<a href="status_order.php?page=<?php echo $page-2; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;"><?php echo $page-2; ?></button></a>
								<?php
									}
									...
									{
								?>
									<a href="status_order.php?page=<?php echo $page-1; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;"><?php echo $page-1; ?></button></a>
								<?php
									}
									if($max_page!=1){
								?>
									<a href="status_order.php?page=<?php echo $page; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;"><?php echo $page; ?></button></a>
								<?php
									}
								...
								<?php
									...
									{
								?>
										<a href="status_order.php?page=<?php echo $page+1; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;">&nbsp;&nbsp;&nbsp;Next&nbsp;&nbsp;&nbsp;</button></a>
								<?php
									}
								}
								?>
