                    ...
                    <div class="col-lg-12">
						...
						<div class="table-responsive">
							...
							<?php
								...
								{
									$sql = "SELECT * FROM new_request WHERE status=1 AND delivered=0 ORDER BY prodate DESC, res_id DESC";
								}	
									...
									if($x>$min && $x<$max)
									{
										...
										if($i%2==0)
												...
												echo "<td align='center'>
														<a href='new_edit.php?res_id=".$row['res_id']."'>
												...
												echo "<td align=center>
														<form action='new_delivered_button.php' method='post' >
