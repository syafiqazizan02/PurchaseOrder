					...
					<div class="col-lg-12">
							...
							<div class="col-lg-6">
								...
								echo "<div class='form-group'>
										...
										<select class='form-control' name='client_name' id='clientID' required>	
								...
								<div align="center" class="form-group">
									...
									<?php echo "<a href='view_order.php?username=$username'><input type='button' class='btn btn-warning' value='BACK'></a>"; ?>
								</div><br><br><br>								
							</div>				
					</div>
				</div>
