<?php
	...
	$sql="INSERT INTO new_item (username, res_id, client_name, company_name, redate, product, model, description, quantity) VALUES ('".$username."','".$res_id."','".$client_name."','".$company_name."','".$redate."','".$product."','***".$model."','".$description."','".$quantity."'";
