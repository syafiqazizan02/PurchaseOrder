      ...
      <div class="container-fluid">
                ...
                <div class="row">
					<div align="left" class="col-lg-8">
						&nbsp;&nbsp;&nbsp;<?php echo" <a href='register_order_pro.php?username=$username'><input type='button' class='btn btn-primary btn-lg'  value='REGISTER END USER'></a>"; ?>
					</div>
						...
						<div class="table-responsive">
							...
							<?php
								...
								while($row=mysql_fetch_array($result))
								{
									...
									if($x>$min && $x<$max)
									{
										...
										<a href='delete_client.php?username=$username&&client_id=".($row["client_id"])."'>
													<button type='submit' name='delete' class='btn btn-danger btn-xs'><span class='glyphicon glyphicon-trash'></span></button</a></td>";
										echo "<td align='center'>
												<a href='display_order_pro.php?username=$username&&client_id=".($row["client_id"])."'>
							...
							<center>
								<?php
									...
									{
								?>
										<a href="history_order_pro.php?username=<?php echo "$username"?>&&page=<?php echo $page-1; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;">&nbsp;&nbsp;&nbsp;Prev&nbsp;&nbsp;&nbsp;</button></a>
								<?php
									}
								?>
								<?php
									...
									{
								?>
									<a href="history_order_pro.php?username=<?php echo "$username"?>&&page=<?php echo $page-2; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;"><?php echo $page-2; ?></button></a>
								<?php
									}
									...
									{
								?>
									<a href="history_order_pro.php?username=<?php echo "$username"?>&&page=<?php echo $page-1; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;"><?php echo $page-1; ?></button></a>
								<?php
									}
									if($max_page!=1){
								?>
									<a href="history_order_pro.php?username=<?php echo "$username"?>&&page=<?php echo $page; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;"><?php echo $page; ?></button></a>
								<?php
									}
								...
								<?php
									...
									{
								?>
										<a href="history_order_pro.php?username=<?php echo "$username"?>&$page=<?php echo $page+1; ?>"><button class="btn-success btn-sm"   style="background:#bf40bf;">&nbsp;&nbsp;&nbsp;Next&nbsp;&nbsp;&nbsp;</button></a>
								<?php
									}
								}
								?>
