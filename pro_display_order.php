...
<form action="pro_add_order.php" method="post" >
					...
					<div class="col-lg-12">
							...
							<?php
								...
								include('dbConfig.php');
										...
										$query = $db->query("SELECT * FROM clients WHERE status = 1 ORDER BY client_name ASC");

										$rowCount = $query->num_rows;
							
								echo "<center><b>End User Information:</b></center>";
								echo "<div class='form-group'>
										<label align='center'><b><p>End User:</p></b></label>
										<select class='form-control' name='client_name' id='clientID' style='width: 730px;' required>	
							...
							?>
								...
								<div align="center" class="form-group">
									...
									<?php echo "<a href='pro_view_order.php?username=$username'><input type='button' class='btn btn-warning' value='BACK'></a>"; ?>
								</div>
							</div>			
					</div>
				</div>
