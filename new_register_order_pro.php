...
<form action="new_add_client.php" method="post" >
					...
					<div class="col-lg-12">
							...
							<div class="col-lg-6">
								...
								<div align="center" class="form-group">
									...
									<?php echo" <a href='new_history_order_pro.php?username=$username'><input type='button' class='btn btn-warning' value='BACK'></a>"; ?>
